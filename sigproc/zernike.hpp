...
namespace mx
{
   namespace sigproc
   {
      ...
      extern template long double zernikeR<long double, long double>(long double rho, int n, int m, std::vector<long double> &c);
      ...
      extern template long double zernike<long double, long double>(long double rho, long double phi, int n, int m, std::vector<long double> &c);

#ifdef HASQUAD
      extern template __float128 zernike<__float128, __float128>(__float128 rho, __float128 phi, int n, int m, std::vector<__float128> &c);
#endif
